...
// Функція містить в собі root url на SWAPI, 
// додає кінцевий ресурс resource і робить запит.
// Після реалізації функції потрібно її протестувати викликавши
// декілька раз з параметрами як вказано нижче і вивести 
// результат виконання запитів - testFetchSWAPI.
